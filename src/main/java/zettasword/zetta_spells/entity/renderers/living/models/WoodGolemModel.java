package zettasword.zetta_spells.entity.renderers.living.models;
...
@OnlyIn(Dist.CLIENT)
public class WoodGolemModel<T extends WoodGolem> extends HierarchicalModel<T> {
   ...
   public WoodGolemModel(ModelPart p_170697_) {
      this.root = p_170697_;
